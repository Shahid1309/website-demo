...
//               <Sparkles className="w-6 h-6 text-blue-600 mr-2 group-hover:rotate-12 transition-transform duration-300" />
...
//             ))}
//             <Link href="/contact">
//               <button className="bg-gradient-to-r from-amber-500 to-yellow-400 hover:from-amber-600 hover:to-yellow-600 text-white px-6 py-2.5 rounded-full transition-all duration-300 font-medium shadow-lg hover:shadow-xl hover:scale-105 flex items-center space-x-2 group">
...
//             className="md:hidden p-2 rounded-lg text-gray-600 hover:text-gray-800 hover:bg-gray-100 focus:outline-none transition-all duration-200"
//           >
...
//               <Link href="/contact">
//                 <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-3 rounded-lg transition-all duration-300 font-medium shadow-lg flex items-center justify-center space-x-2 group">
//                   <span>Get Started</span>
//                   <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
//                 </button>
//               </Link>
