...
// export default function WhyChooseUs() {
//   return (
//     <section className="py-20 bg-[#0f0f0f] text-gray-200">
//       <div className="max-w-6xl mx-auto px-4 text-center">
...
//             <div
//               key={index}
//               className="bg-[#1a1a1a] hover:bg-[#222] border border-gray-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300"
//             >
//               <div className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-gray-700 to-black rounded-full mx-auto mb-6 shadow-inner">
//                 {item.icon}
//               </div>
